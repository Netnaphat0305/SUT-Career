...
func UpdateStudent(c *gin.Context) {
	...
	student.Year = payload.Year
	student.Skills = payload.Skills
	student.ProfileImageUrl = payload.ProfileImageUrl 

	// FIX: Add BankAccount and BankID to the update logic
	student.BankAccount = payload.BankAccount
	student.BankID = payload.BankID
